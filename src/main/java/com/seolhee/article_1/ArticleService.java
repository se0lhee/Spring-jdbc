...
public class ArticleService {
	...
	public void addArticle() {
		...
		article.setTitle("‘강원 산불’ 불똥 맞은 나경원···“심각성 몰랐다” 해명도 논란");
		article.setContent(
				"4일 국회 운영위서 정의용 국가안보실장 이석 방해 논란 / 나경원 \"회의 집중하느라 산불 알지 못했다\" 해명 / 일각서 \"해명이 화 키우고 있다\" 지적도 / \"질문이 중요하냐, 생명이 중요하냐\" 與, 한국당 맹비난");
		article.setUserId("1");
		article.setName("배설희");
